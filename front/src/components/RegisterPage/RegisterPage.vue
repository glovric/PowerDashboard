...
<script setup>
  ...
  const { username, email, password, showPassword, message, error, handleRegister, togglePasswordVisibility } = useRegisterPage();
</script>

<style lang="scss" src="@/styles/LoginPage.scss" scoped></style>
